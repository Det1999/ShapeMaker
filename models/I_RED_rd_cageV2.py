...
from models.cage.cage_skinning import CageSkinningV2

EPS = 1e-10


class I_RED_rd_cageV2(nn.Module):
    def __init__(self, opt, partial = True):
        super(I_RED_rd_cageV2, self).__init__()
        self.opt = opt
        ...
        self.cage_deform_netv2 = CageSkinningV2(opt)
    ...
    def forward(self, pred_f_RandD, pred_p_RandD = None):
        ...
        if pred_p_RandD != None:
            ...
            cage_out = self.cage_deform_netv2(pred_f_RandD,pred_p_RandD)
        else:
            cage_out = None
    ...
    def get_optim_params(self):
        if self.use_partial:
            params = itertools.chain(self.full_seg_net.parameters(), self.cage_deform_netv2.parameters(),
